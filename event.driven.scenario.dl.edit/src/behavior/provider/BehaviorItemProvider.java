...
/**
 * This is the item provider adapter for a {@link behavior.Behavior} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BehaviorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Behavior_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Behavior_name_feature", "_UI_Behavior_type"),
				 BehaviorPackage.Literals.BEHAVIOR__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviorPackage.Literals.BEHAVIOR__PARAMETERS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Behavior.class)) {
			case BehaviorPackage.BEHAVIOR__NAME:
				...
				return;
			case BehaviorPackage.BEHAVIOR__PARAMETERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.BEHAVIOR__PARAMETERS,
