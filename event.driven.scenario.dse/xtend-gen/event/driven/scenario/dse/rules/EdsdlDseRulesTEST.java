...
public class EdsdlDseRulesTEST {
  @Extension
  ...
  public void actuateModel(final DynamicEntity de, final String rule) {
    ...
    EList<RuntimeState> _runtimestate = de.getContainedIn().getStateMachine().getRuntimestate();
    for (final RuntimeState r : _runtimestate) {
      boolean _equals_1 = r.getActor().equals(de.getName());
      if (_equals_1) {
        EList<Transition> _outTransitions = r.getActualState().getOutTransitions();
