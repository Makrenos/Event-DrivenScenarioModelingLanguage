...
public class StateTransitionBasedDfsStrategyTEST implements StateTransitionBasedIStrategy{
     ...
     */
    public StateTransitionBasedDfsStrategyTEST() {
    	this.time = (float) 0;
     ...
     */
    public StateTransitionBasedDfsStrategyTEST(int maxDepth) {
        if (maxDepth < 0) {
            this.maxDepth = Integer.MAX_VALUE;
        } else {
     ...
     * the search space.
     */
    public StateTransitionBasedDfsStrategyTEST continueIfHardObjectivesFulfilled() {
    ...
    private void startThreads() {
        context.startAllThreads(() -> new StateTransitionBasedDfsStrategyTEST(maxDepth));
    }
