...
public class StateTransitionBasedBfsStrategy implements StateTransitionBasedIStrategy {
     ...
     */
    public StateTransitionBasedBfsStrategy() {
     ...
     */
    public StateTransitionBasedBfsStrategy(int maxDepth) {
        if (maxDepth < 0) {
            this.maxDepth = Integer.MAX_VALUE;
        } else {
    ...
    public void explore() {
        ...
        mainLoop: while (!isInterrupted && !shared.isDesignSpaceTraversed()) {
            ...
            Collection<Object> activationIds = context.getCurrentActivationIdsOLD();
    ...
    private void startThreads() {
        context.startAllThreads(() -> new StateTransitionBasedBfsStrategy(maxDepth));
    }
