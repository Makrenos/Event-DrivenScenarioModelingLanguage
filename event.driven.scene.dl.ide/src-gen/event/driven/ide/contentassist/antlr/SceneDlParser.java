...
public class SceneDlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SceneDlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDynamicEntityAccess().getAlternatives_4_1(), "rule__DynamicEntity__Alternatives_4_1");
			builder.put(grammarAccess.getDynamicEntityAccess().getAlternatives_4_2(), "rule__DynamicEntity__Alternatives_4_2");
			...
			builder.put(grammarAccess.getDynamicEntityAccess().getGroup_4_2_0(), "rule__DynamicEntity__Group_4_2_0__0");
			builder.put(grammarAccess.getDynamicEntityAccess().getGroup_4_2_1(), "rule__DynamicEntity__Group_4_2_1__0");
			builder.put(grammarAccess.getFeatureAccess().getGroup(), "rule__Feature__Group__0");
			builder.put(grammarAccess.getContainAccess().getGroup(), "rule__Contain__Group__0");
			...
			builder.put(grammarAccess.getDynamicEntityAccess().getAttributesAssignment_4_1_0(), "rule__DynamicEntity__AttributesAssignment_4_1_0");
			builder.put(grammarAccess.getDynamicEntityAccess().getContainsAssignment_4_1_1(), "rule__DynamicEntity__ContainsAssignment_4_1_1");
			builder.put(grammarAccess.getDynamicEntityAccess().getAttributesAssignment_4_2_0_1(), "rule__DynamicEntity__AttributesAssignment_4_2_0_1");
			builder.put(grammarAccess.getDynamicEntityAccess().getContainsAssignment_4_2_1_1(), "rule__DynamicEntity__ContainsAssignment_4_2_1_1");
			...
			builder.put(grammarAccess.getContainAccess().getManyAssignment_0(), "rule__Contain__ManyAssignment_0");
			builder.put(grammarAccess.getContainAccess().getNameAssignment_1(), "rule__Contain__NameAssignment_1");
			builder.put(grammarAccess.getContainAccess().getTypeAssignment_3(), "rule__Contain__TypeAssignment_3");
