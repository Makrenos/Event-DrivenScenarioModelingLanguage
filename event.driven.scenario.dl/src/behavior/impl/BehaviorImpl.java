 ...
 * </p>
 * <ul>
 *   <li>{@link behavior.impl.BehaviorImpl#getName <em>Name</em>}</li>
 *   <li>{@link behavior.impl.BehaviorImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorImpl extends MinimalEObjectImpl.Container implements Behavior {
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, BehaviorPackage.BEHAVIOR__PARAMETERS);
		}
		return parameters;
	}
