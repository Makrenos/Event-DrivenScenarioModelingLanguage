...
public class BehaviorFactoryImpl extends EFactoryImpl implements BehaviorFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BehaviorPackage.BEHAVIOR_LIST: return createBehaviorList();
			case BehaviorPackage.LISTS_OF_BEHAVIORS: return createListsOfBehaviors();
			default:
	 ...
	 * @generated
	 */
	public BehaviorList createBehaviorList() {
		BehaviorListImpl behaviorList = new BehaviorListImpl();
		return behaviorList;
	}
	 ...
	 * @generated
	 */
	public ListsOfBehaviors createListsOfBehaviors() {
		ListsOfBehaviorsImpl listsOfBehaviors = new ListsOfBehaviorsImpl();
