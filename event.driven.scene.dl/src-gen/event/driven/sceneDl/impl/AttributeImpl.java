 ...
 * </p>
 * <ul>
 *   <li>{@link event.driven.sceneDl.impl.AttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link event.driven.sceneDl.impl.AttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link event.driven.sceneDl.impl.AttributeImpl#isIsTransient <em>Is Transient</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeImpl extends MinimalEObjectImpl.Container implements Attribute
{
   ...
   * @ordered
   */
  protected static final AttributeType TYPE_EDEFAULT = AttributeType.RANGE;
  ...
  {
    return SceneDlPackage.Literals.ATTRIBUTE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SceneDlPackage.ATTRIBUTE__NAME, oldName, name));
  }
  ...
  public void setType(AttributeType newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SceneDlPackage.ATTRIBUTE__TYPE, oldType, type));
  }
  ...
  public void setIsTransient(boolean newIsTransient)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SceneDlPackage.ATTRIBUTE__IS_TRANSIENT, oldIsTransient, isTransient));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SceneDlPackage.ATTRIBUTE__NAME:
        return getName();
      case SceneDlPackage.ATTRIBUTE__TYPE:
        return getType();
      case SceneDlPackage.ATTRIBUTE__IS_TRANSIENT:
