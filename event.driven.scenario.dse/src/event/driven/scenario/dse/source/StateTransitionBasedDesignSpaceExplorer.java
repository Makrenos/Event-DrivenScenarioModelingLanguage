...
public class StateTransitionBasedDesignSpaceExplorer {
	 private Notifier model;

	    private StateTransitionBasedGlobalContext globalContext = new StateTransitionBasedGlobalContext();
	     ...
	     * 
	     */
	    public StateTransitionBasedDesignSpaceExplorer() {
	     ...
	     */
	    public void addGlobalConstraint(StateTransitionBasedIGlobalConstraint constraint) {
	     ...
	     * @see IObjective
	     */
	    public void addObjective(StateTransitionBasedIObjective objective) {
	        for (StateTransitionBasedIObjective o : globalContext.getObjectives()) {
	     ...
	     */
	    public void startExploration(StateTransitionBasedIStrategy strategy) {
	     ...
	     *            The strategy of the exploration.
	     */
	    public void startExplorationAsync(StateTransitionBasedIStrategy strategy) {
	     ...
	     */
	    public boolean startExplorationWithTimeout(StateTransitionBasedIStrategy strategy, long timeout) {
	     ...
	     * @return Returns true if the exploration stopped by the timeout.
	     */
	    public boolean startExplorationAsyncWithTimeout(StateTransitionBasedIStrategy strategy, long timeout) {
	     ...
	     * @return Returns true if the exploration stopped by the timeout.
	     */
	    public boolean startExploration(StateTransitionBasedIStrategy strategy, boolean waitForTermination, final long timeout) {
	    ...
	    private void initExploration(StateTransitionBasedIStrategy strategy) {
	     ...
	     * @param visualizer
	     */
	    public void addDesignSpaceVisulaizer(StateTransitionBasedIDesignSpaceVisualizer visualizer) {
	    ...
	    public static void turnOnLogging(DseLoggingLevel dseLoggingLevel) {
	        ...
	        case OFF:
	            Logger.getLogger(StateTransitionBasedDesignSpaceExplorer.class).setLevel(Level.OFF);
	            Logger.getLogger(StateTransitionBasedIStrategy.class).setLevel(Level.OFF);
	            Logger.getLogger(StateTransitionBasedDesignSpaceManager.class).setLevel(Level.OFF);
	            break;
	        case WARN:
	            Logger.getLogger(StateTransitionBasedDesignSpaceExplorer.class).setLevel(Level.WARN);
	            Logger.getLogger(StateTransitionBasedIStrategy.class).setLevel(Level.WARN);
	            Logger.getLogger(StateTransitionBasedDesignSpaceManager.class).setLevel(Level.WARN);
	            break;
	        case BASIC:
	            Logger.getLogger(StateTransitionBasedDesignSpaceExplorer.class).setLevel(Level.INFO);
	            Logger.getLogger(StateTransitionBasedIStrategy.class).setLevel(Level.INFO);
	            Logger.getLogger(StateTransitionBasedDesignSpaceManager.class).setLevel(Level.WARN);
	            break;
	        case VERBOSE_STRATEGY:
	            Logger.getLogger(StateTransitionBasedDesignSpaceExplorer.class).setLevel(Level.DEBUG);
	            Logger.getLogger(StateTransitionBasedIStrategy.class).setLevel(Level.DEBUG);
	            Logger.getLogger(StateTransitionBasedDesignSpaceManager.class).setLevel(Level.WARN);
	            break;
	        case VERBOSE_FULL:
	            Logger.getLogger(StateTransitionBasedDesignSpaceExplorer.class).setLevel(Level.DEBUG);
	            Logger.getLogger(StateTransitionBasedIStrategy.class).setLevel(Level.DEBUG);
	            Logger.getLogger(StateTransitionBasedDesignSpaceManager.class).setLevel(Level.DEBUG);
	            break;
	        default:
